...
OUTPUT FORMAT — JSON THUẦN, KHÔNG THÊM BẤT CỨ TEXT NÀO BÊN NGOÀI:
{
  ...
  ${isFemaleClothing ? `"imagePrompts": [
    "Photorealistic vertical photo. Setting: ${sceneContext}. Beautiful Vietnamese countryside woman, 158cm, 62kg, slightly chubby and soft body, long straight black hair, fair smooth skin, round chubby face with natural rural charm, cheeky cheeks, no heavy makeup, gentle warm expression, full curvy figure, wearing the product, standing facing camera, confident natural smile. Natural daylight. Candid lifestyle. No text, no logo.",
    "Photorealistic vertical photo. Setting: ${sceneContext}. Beautiful Vietnamese countryside woman, 158cm, 62kg, slightly chubby and soft body, long straight black hair, fair smooth skin, round chubby face with natural rural charm, cheeky cheeks, no heavy makeup, gentle warm expression, full curvy figure, wearing the product, turning sideways showing full silhouette, soft relaxed expression. Warm indoor light. Candid style. No text, no logo.",
    "Photorealistic vertical photo. Setting: rural Mekong Delta Vietnam countryside road, lush tropical greenery, banana trees, coconut palms, rice fields in background, natural warm sunlight. Beautiful Vietnamese countryside woman, 158cm, 62kg, slightly chubby and soft body, long straight black hair, fair smooth skin, round chubby face with natural rural charm, cheeky cheeks, no heavy makeup, gentle warm expression, full curvy figure, wearing the product, candid walking shot from slight angle. No text, no logo.",
    "Photorealistic vertical photo. Setting: ${outdoorScene4}. Beautiful Vietnamese countryside woman, 158cm, 62kg, slightly chubby and soft body, long straight black hair, fair smooth skin, round chubby face with natural rural charm, cheeky cheeks, no heavy makeup, gentle warm expression, full curvy figure, wearing the product, relaxed candid pose, natural authentic expression. No text, no logo.",
