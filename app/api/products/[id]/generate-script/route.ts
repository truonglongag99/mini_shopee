...
// ============================================================
// FEMALE CHARACTER SPEC — dùng chung cho tất cả image prompts
// ============================================================
const femaleCharacterSpec = `A young Vietnamese woman with a soft, slightly chubby body shape — visible soft belly, fuller arms and thighs, no waist slimming, no hourglass shape. Natural and relatable everyday appearance, NOT a model. She has a soft oval face with full cheeks, warm tan skin with natural texture (visible pores, slight uneven skin tone — no beauty filter, no skin smoothing). Neat black hair tied loosely back with one or two strands naturally out of place. Minimal makeup, no-filter natural look, gentle and confident expression.`

const technicalSpec = `Shot on smartphone, candid phone photo quality, vertical composition, background naturally visible and in focus — no heavy bokeh, no studio blur. ENFORCE: no waist slimming, no hourglass reshaping, keep natural soft belly and fuller figure as described. Fabric slightly wrinkled at natural wear points (waist, elbow, hip). No beauty filter, no skin retouching, no AI smoothing. Slightly imperfect is correct and intentional. FACE RULE: the woman's face (eyes, nose, mouth) must NOT be visible in the image — use camera angle, head direction, hair, or hands to hide it completely. The model MUST be fully clothed at all times — do not omit, expose, or partially remove any clothing. No text, no logo.`
...
OUTPUT FORMAT — JSON THUẦN, KHÔNG THÊM BẤT CỨ TEXT NÀO BÊN NGOÀI:
{
  ...
  ${isFemaleClothing ? `"imagePrompts": [
    "CONCEPT 1 — Đời thường, dễ mặc. Write a complete English image prompt: [CHARACTER] ${femaleCharacterSpec} [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: \\"${product.description ?? product.name}\\". Describe the garment accurately using only these details.]. [POSE] Relaxed and natural — doing something ordinary like walking on a dirt path, sitting on porch steps, or adjusting her hair. Posture slightly curved, hands casually by her side or in pockets. FACE: must not be visible — head tilted fully downward, face turned away from camera, or frame cuts below chin. Hair naturally falling forward to cover face. Eyes, nose, mouth must not appear in frame. [SETTING] Rural Mekong Delta Vietnam countryside — wooden house porch, earthen road, banana trees, tropical greenery, rice fields in background. Warm golden hour sunlight, soft highlights and gentle shadows. [TECHNICAL] ${technicalSpec}",
    "CONCEPT 2 — Che khuyết điểm. Write a complete English image prompt: [CHARACTER] ${femaleCharacterSpec} [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: \\"${product.description ?? product.name}\\". Describe the garment accurately using only these details.] — the outfit naturally flatters her soft curves and drapes gracefully over her fuller figure, concealing problem areas while looking effortless. [POSE] Standing naturally, one hand lightly touching the fabric at the waist, slight 3/4 angle to show how the clothing fits on a real body — posture relaxed, not stiff. FACE: must not be visible — head turned fully away, face looking downward, or frame cuts below chin. Eyes, nose, mouth must not appear in frame. [SETTING] ${sceneContext}. Soft diffused natural light, no harsh shadows. [TECHNICAL] ${technicalSpec}",
    "CONCEPT 3 — Outfit đi làm / đi chơi. Write a complete English image prompt: [CHARACTER] ${femaleCharacterSpec} [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: \\"${product.description ?? product.name}\\". Describe the garment accurately using only these details.] styled as a complete casual outing or light workday outfit. She looks put-together without trying too hard. [POSE] Relaxed and confident — walking or standing near a doorway, bag on shoulder or holding a small item, posture natural and unstaged. FACE: must not be visible — shot from behind, face turned fully away, or frame cuts below chin. Eyes, nose, mouth must not appear in frame. [SETTING] Simple rural Vietnamese setting — small market alley, riverside path in Mekong Delta, or simple wooden shop front. Warm ambient daylight, authentic Vietnamese atmosphere. [TECHNICAL] ${technicalSpec}",
    "CONCEPT 4 — POV nữ. Write a complete English image prompt: [SHOT TYPE] Full body shot from a slightly elevated angle — no face visible (frame cuts off at neck or chin level, or subject is looking down so face is hidden). The entire outfit must be clearly visible from neckline to hem/feet — do NOT crop the clothing. [VISIBLE ELEMENTS] Full outfit on body, both hands naturally visible — slightly chubby soft arms and hands, no heavy jewelry, light nail color or bare nails. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: \\"${product.description ?? product.name}\\". Describe the garment accurately using only these details.]. [SETTING] ${outdoorScene4}. Warm soft natural light falling on the outfit. Ground or background naturally visible below. [TECHNICAL] ${technicalSpec} No face visible.",
    "CONCEPT 5 — Sinh hoạt đời thường miền Tây. Write a complete English image prompt: [CHARACTER] ${femaleCharacterSpec} Fully absorbed in what she is doing, not posing. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: \\"${product.description ?? product.name}\\". Describe the garment accurately using only these details.] as casual home wear, looking completely natural and effortless. [ACTIVITY] Choose one authentic rural Vietnamese daily scene that fits the outfit best: (a) squatting picking and sorting fresh vegetables in a wicker basket — head tilted fully downward so face is completely hidden by hair and angle, (b) standing at a rustic outdoor washbasin with both hands pressing a towel or splashing water fully covering the entire face — eyes, nose, and mouth completely hidden behind hands, (c) bending to scoop water from a large traditional clay water jar (lu) — face turned fully away from camera or buried in the crook of one arm. IMPORTANT: if any part of the head is in frame, the face (eyes, nose, mouth) must be 100% hidden — by hands, towel, hair, or camera angle. The outfit must remain fully visible. [SETTING] Rural Mekong Delta Vietnamese home — simple earthen or tiled floor, weathered wooden walls, clay water jar, wicker baskets, tropical plants nearby, dappled natural light. Warm soft morning light. [TECHNICAL] ${technicalSpec}"
  ]` : `"imagePrompt": "Write a complete English image prompt: [CHARACTER] ${femaleCharacterSpec} [PRODUCT] She is using or wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent details not mentioned: \\"${product.description ?? product.name}\\"]. [SETTING] ${sceneContext}. ${selectedAngle}. Warm natural lighting. [TECHNICAL] ${technicalSpec}"`},
