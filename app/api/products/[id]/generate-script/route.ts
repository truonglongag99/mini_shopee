...
OUTPUT FORMAT — JSON THUẦN, KHÔNG THÊM BẤT CỨ TEXT NÀO BÊN NGOÀI:
{
  ...
  ${isFemaleClothing ? `"imagePrompts": [
    "CONCEPT 1 — Đời thường, dễ mặc. Write a complete English image prompt using this exact structure: [CHARACTER] A young Vietnamese woman with a soft, slightly chubby body shape, natural and relatable everyday appearance. She has a soft oval face with full cheeks, warm tan skin with natural texture — visible pores, slight uneven skin tone, no beauty filter, no skin smoothing. Neat black hair tied loosely back with one or two strands naturally out of place. Minimal makeup, no-filter natural look, gentle and confident expression. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: "${product.description ?? product.name}". Describe the garment accurately using only these details.]. [POSE] Relaxed and natural — doing something ordinary like walking on a dirt path, sitting on porch steps, or adjusting her hair. Posture slightly curved, hands casually by her side or in pockets, emphasizing softness and approachability rather than sharp angles. [SETTING] Rural Mekong Delta Vietnam countryside — wooden house porch, earthen road, banana trees, tropical greenery, rice fields in background. Warm golden hour sunlight, soft highlights and gentle shadows. [TECHNICAL] Shot on smartphone, candid phone photo quality, vertical composition, background naturally visible and in focus — no heavy bokeh, no studio blur. IMPORTANT: no waist slimming, no hourglass reshaping, keep natural soft waistline and belly as described. Fabric slightly wrinkled at natural wear points (waist, elbow, hip). No beauty filter, no skin retouching, no AI smoothing. Real-life authentic feel — slightly imperfect is correct. The model MUST be fully clothed at all times — do not omit, expose, or partially remove any clothing. No text, no logo.",
    "CONCEPT 2 — Che khuyết điểm. Write a complete English image prompt using this exact structure: [CHARACTER] A young Vietnamese woman with a soft, slightly chubby body shape, natural and relatable everyday appearance. She has a soft oval face with full cheeks, smooth warm tan skin, and neat black hair tied loosely back. Minimal makeup, natural fresh look, gentle expression. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: "${product.description ?? product.name}". Describe the garment accurately using only these details.] — the outfit naturally flatters her soft curves and drapes gracefully over her fuller figure, concealing problem areas while looking effortless. [POSE] Standing naturally, one hand lightly touching the fabric at the waist, slight 3/4 angle to show how the clothing fits on a real body — posture relaxed, not stiff. [SETTING] ${sceneContext}. Soft diffused natural light, no harsh shadows. [TECHNICAL] Shot on smartphone, candid phone photo quality, vertical composition, background naturally visible and in focus — no heavy bokeh, no studio blur. IMPORTANT: no waist slimming, no hourglass reshaping, keep natural soft waistline and belly as described. Fabric slightly wrinkled at natural wear points (waist, elbow, hip). No beauty filter, no skin retouching, no AI smoothing. Real-life authentic feel — slightly imperfect is correct. The model MUST be fully clothed at all times — do not omit, expose, or partially remove any clothing. No text, no logo.",
    "CONCEPT 3 — Outfit đi làm / đi chơi. Write a complete English image prompt using this exact structure: [CHARACTER] A young Vietnamese woman with a soft, slightly chubby body shape, natural and relatable everyday appearance. She has a soft oval face with full cheeks, smooth warm tan skin, and neat black hair tied loosely back. Minimal makeup, natural fresh look, looks put-together without trying too hard. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: "${product.description ?? product.name}". Describe the garment accurately using only these details.] styled as a complete casual outing or light workday outfit. [POSE] Relaxed and confident — walking or standing near a doorway, bag on shoulder or holding a small item, posture natural and unstaged. [SETTING] Simple rural Vietnamese setting — small market alley, riverside path in Mekong Delta, or simple wooden shop front. Warm ambient daylight, authentic Vietnamese atmosphere. [TECHNICAL] Shot on smartphone, candid phone photo quality, vertical composition, background naturally visible and in focus — no heavy bokeh, no studio blur. IMPORTANT: no waist slimming, no hourglass reshaping, keep natural soft waistline and belly as described. Fabric slightly wrinkled at natural wear points (waist, elbow, hip). No beauty filter, no skin retouching, no AI smoothing. Real-life authentic feel — slightly imperfect is correct. The model MUST be fully clothed at all times — do not omit, expose, or partially remove any clothing. No text, no logo.",
    "CONCEPT 4 — POV nữ. Write a complete English image prompt using this exact structure: [SHOT TYPE] First-person POV shot looking down — camera positioned at chest height, viewer IS the woman wearing the outfit. [VISIBLE ELEMENTS] The clothing covering the body from chest to legs or feet, two hands with natural feminine appearance resting casually — one on hip, one by side or in pocket. Slightly chubby soft arms and hands, no heavy jewelry, light nail color or bare nails. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: "${product.description ?? product.name}". Describe the garment accurately using only these details.]. [SETTING] ${outdoorScene4}. Warm soft natural light falling on the outfit. Ground or background softly visible below. [TECHNICAL] Photorealistic, high detail, vertical composition, slight wide-angle feel, shallow depth of field. No face visible. No text, no logo.",
    "CONCEPT 5 — Sinh hoạt đời thường miền Tây. Write a complete English image prompt using this exact structure: [CHARACTER] A young Vietnamese woman with a soft, slightly chubby body shape, natural and relatable everyday appearance. She has a soft oval face with full cheeks, smooth warm tan skin, and neat black hair tied loosely back. Minimal makeup, no-fuss natural look, fully absorbed in what she is doing. [OUTFIT] She is wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent or add any color, fabric, or style not mentioned: "${product.description ?? product.name}". Describe the garment accurately using only these details.] as casual home wear, looking completely natural and effortless. [ACTIVITY] Choose one of these authentic rural Vietnamese daily scenes that fits the outfit best: (a) squatting on the ground picking and sorting fresh vegetables in a wicker basket on a simple tiled floor, (b) standing at a rustic outdoor washbasin splashing water on her face with both hands, eyes closed, or (c) bending slightly to scoop water from a large traditional clay water jar (lu) using a wooden or coconut-shell ladle. The activity is candid and unstaged — she is not posing, just living her day. [SETTING] Rural Mekong Delta Vietnamese home — simple earthen or tiled floor, weathered wooden walls, clay water jar, wicker baskets, tropical plants nearby, dappled natural light filtering through gaps. Warm soft morning light. [TECHNICAL] Shot on smartphone, candid phone photo quality, vertical composition, background naturally visible and in focus — no heavy bokeh, no studio blur. IMPORTANT: no waist slimming, no hourglass reshaping, keep natural soft waistline and belly as described. Fabric slightly wrinkled at natural wear points (waist, elbow, hip). No beauty filter, no skin retouching, no AI smoothing. Real-life authentic feel — slightly imperfect is correct. The model MUST be fully clothed at all times — do not omit, expose, or partially remove any clothing. No text, no logo."
  ]` : `"imagePrompt": "Write a complete English image prompt: [CHARACTER] A young Vietnamese woman with a soft, slightly chubby body shape, natural relatable appearance, soft oval face with full cheeks, smooth warm tan skin, neat black hair, minimal makeup, real-person candid vibe. [PRODUCT] She is using or wearing [PRODUCT INFO — copy only what is explicitly stated here, do NOT invent details not mentioned: "${product.description ?? product.name}"]. [SETTING] ${sceneContext}. ${selectedAngle}. Warm natural lighting. [TECHNICAL] Photorealistic, high detail, vertical composition, shallow depth of field. No text, no watermark, no logo."`},
