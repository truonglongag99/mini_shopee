...
OUTPUT FORMAT — JSON THUẦN, KHÔNG THÊM BẤT CỨ TEXT NÀO BÊN NGOÀI:
{
  ...
  ${isFemaleClothing ? `"imagePrompts": [
    ...
    "CONCEPT 5 — Reaction từ người khác. Write a complete English image prompt using this exact structure: [CHARACTERS] Two young Vietnamese women, both with soft slightly chubby body shapes, girl-next-door appearance, smooth warm tan skin, natural minimal makeup, black hair — they look like real friends not models. [OUTFIT] The woman on the left is wearing [describe exactly: color, silhouette, cut, fabric of product '${product.name}' based on: ${product.description ?? product.name}]. [INTERACTION] The other woman is reacting naturally — leaning in to touch the fabric with curiosity, tilting her head with an impressed look, or asking about it. Both expressions are genuine and candid, feels like a real conversation between friends. [SETTING] ${sceneContext}. Warm natural daylight, casual outdoor or semi-indoor rural Vietnamese backdrop. [TECHNICAL] Photorealistic, high detail, vertical composition, shallow depth of field, soft background blur. No text, no logo."
