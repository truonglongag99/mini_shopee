...
OUTPUT FORMAT — JSON THUẦN, KHÔNG THÊM BẤT CỨ TEXT NÀO BÊN NGOÀI:
{
  ...
  ${isFemaleClothing ? `"imagePrompts": [
    "Photorealistic vertical photo. Setting: ${sceneContext}. Beautiful Vietnamese woman, fair smooth porcelain skin, curvy soft figure, wearing the product, standing pose facing camera, confident smile. Natural daylight. Candid lifestyle style. No text, no logo.",
    "Photorealistic vertical photo. Setting: ${sceneContext}. Beautiful Vietnamese woman, fair smooth porcelain skin, curvy soft figure, wearing the product, turning sideways showing silhouette, soft expression. Warm indoor light. Candid style. No text, no logo.",
    "Photorealistic vertical photo. Setting: outdoor café or street. Beautiful Vietnamese woman, fair smooth porcelain skin, curvy soft figure, wearing the product, walking candid shot from behind at angle. Natural bright light. No text, no logo.",
    "Photorealistic vertical photo. Setting: mirror selfie in bedroom. Beautiful Vietnamese woman, fair smooth porcelain skin, curvy soft figure, wearing the product, taking mirror photo, playful expression. Warm lamp light. No text, no logo.",
    "Photorealistic vertical photo. Setting: ${sceneContext}. Close-up from waist up, beautiful Vietnamese woman, fair smooth porcelain skin, wearing the product, looking down slightly, natural relaxed pose. Soft diffused light. No text, no logo."
